...
function HowItWorks() {
	return (
		<StyledContainer>
			...
			<p>
				Lorem ipsum dolor sit amet, consectetur adipisicing elit. Rerum deserunt expedita assumenda
				nulla consectetur porro saepe est, tempora earum ea error eos vero distinctio a!
			</p>
			<div className="stepperWrapper">
				...
				<div className="step">
					...
					<p>Compare prices, profiles, and reviews, then hire the pro that’s right for you.</p>
				</div>
			</div>
		</StyledContainer>
	);
