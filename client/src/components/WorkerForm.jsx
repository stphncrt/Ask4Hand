...
const WorkerForm = () => {
	const { titles, getTitles, updateWorker, postWorker, worker } = useContext(AppContext);
					...
					<Grid container spacing={3}>
						...
						<Grid item xs={12}>
							<TextField
								...
								onChange={formik.handleChange}
								name="workRange"
								error={formik.touched.workRange && Boolean(formik.errors.workRange)}
								helperText={formik.touched.workRange && formik.errors.workRange}
							/>
						</Grid>
						<Grid item xs={6}>
							<TextField
								label={pathName === "/register" ? "Enter Password" : "Change Password"}
								variant="outlined"
								fullWidth
						...
						<Grid item xs={6}>
							<TextField
								...
								type="password"
								error={formik.touched.validatePassword && Boolean(formik.errors.validatePassword)}
